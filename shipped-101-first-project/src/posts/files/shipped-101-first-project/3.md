...
If things are working properly you should see the word OKAY, else you should see the NOT OKAY as the response;
...
Next we will go back to the Shipped UI to deploy our project into a new staging environment we will create!
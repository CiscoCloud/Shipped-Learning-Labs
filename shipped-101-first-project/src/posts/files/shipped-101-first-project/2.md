...
![](posts/files/shipped-101-first-project/letsgetsetup.png)

Paste the curl command into this terminal window and press enter.

![](posts/files/shipped-101-first-project/terminalwithbootstrapcmd.png)
...
![](posts/files/shipped-101-first-project/bootstrapstarting.png)
